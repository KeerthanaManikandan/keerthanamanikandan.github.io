...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
  ...
  },{id: "nav-publications-and-posters",
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-released-the-latest-edition-of-cnbc-spotlights-newsletter",
          title: 'Released the latest edition of CNBC Spotlights newsletter',
          description: "",
          section: "News",},{id: "news-my-abstract-was-accepted-for-a-trainee-talk-at-simian-collective-in-august-2025",
          title: 'My abstract was accepted for a trainee talk at Simian Collective in August...',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6B%65%6D%32%39%34@%70%69%74%74.%65%64%75", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/KeerthanaManikandan", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/keerthana-manikandan", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0000-0002-6461-1930", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=kmQ2Y5sAAAAJ&hl=en", "_blank");
        },
      },{
        id: 'social-x',
        title: 'X',
        section: 'Socials',
        handler: () => {
          window.open("https://twitter.com/Keerthana715", "_blank");
        },
      },{
      id: 'light-theme',
